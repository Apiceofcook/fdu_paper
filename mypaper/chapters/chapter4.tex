...
\section{背景}
随着多模态大语言模型（Multimodal Large Language Model, MLLM）在通用视觉理解任务上的快速突破，面向真实设备自动化的\textbf{UI Agent}逐渐成为落地应用的重要方向。与通用场景不同，移动端与桌面端GUI具有\textbf{控件密集、文字细小、布局强约束、交互强状态}等特征，使得模型在“看懂屏幕”这一前置能力上面临更高门槛。
